...
enum Messages {
	# Índices deben coincidir EXACTAMENTE con VB6 (eMessages en Declares.bas)
	NPCSwing = 0,
	NPCKillUser = 1,
	...
	NPCHitUser = 11,
	UserHitNPC = 12,
	UserAttackedSwing = 13,
	UserHittedByUser = 14,
	UserHittedUser = 15,
	WorkRequestTarget = 16,
	HaveKilledUser = 17,
	UserKill = 18,
	NPCKill = 19,
	EarnExp = 20,
	...
	UserMuerto = 24,
	NpcInmune = 25,
	Hechizo_HechiceroMSG_NOMBRE = 26,
	Hechizo_HechiceroMSG_ALGUIEN = 27,
	Hechizo_HechiceroMSG_CRIATURA = 28,
	Hechizo_PropioMSG = 29,
	Hechizo_TargetMSG = 30
}
